...
[![npm (scoped with tag)](https://img.shields.io/npm/v/@concurrent-tasks/node/next)][node] ![npm bundle size (scoped)](https://img.shields.io/bundlephobia/minzip/@concurrent-tasks/node) ![tree-shaking](https://badgen.net/bundlephobia/tree-shaking/@concurrent-tasks/node)
